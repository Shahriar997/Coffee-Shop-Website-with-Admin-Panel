                    ...
                    if(in_array($fileActualExt,$allowed)){
                        if($fileError === 0){
                            if($fileSize < 500000){
                                ...
                                $price = $_POST['price'];
                                $sql = "INSERT INTO `menu`( `Name`, `Description`, `image`, `price`) VALUES ('".$name."','".$description."','".$fileNameNew."','".$price."')";
                                if(mysqli_query($conn,$sql)){
                                    echo '<script> alert("Added to Menu"); </script>';
...
<html>
                <head>
                    ...
                    <link rel="stylesheet" type="text/css" href="\coffeeshop\css\addMenu.css">
                </head>
                <title> Menu </title>
                <body>
                    <section>
                        ...
                        <div class="container">
                            <h2>Add to Menu</h2>
                            <div class = add-form>
                                <form method="POST" action="addMenu.php?action=add" enctype="multipart/form-data">
